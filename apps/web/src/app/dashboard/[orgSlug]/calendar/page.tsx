...
export default function CalendarPage() {
  return (
    <div className="space-y-4 animate-fade-in">
      <h1 className="text-xl font-bold tracking-tight">Calendar Schedule</h1>
      <Card className="p-12 text-center max-w-md mx-auto bg-muted/20 border-border/50">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          The Calendar dashboard schedule view is coming soon in a future update. We're currently
          focus-building the Kanban board core features.
        </p>
      </Card>
    </div>
  );
